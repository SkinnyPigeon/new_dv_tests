...
engine = create_engine(
    'postgresql://postgres:{}@localhost:{}/data_vault'.format(PASSWORD, PORT))
...
class HubTime(Base):
    ...
    # __table_args__ = {'schema': 'insert random schema name here'}
...
class SatEventDiagnosticDetails(Base):
    ____tablename__ = 'sat_event_diagnostic_details'
    # __table_args__ = {'schema': 'insert random schema name here'}
    id = Column(Integer, primary_key=True)
...
class SatTimeEpisodeDetails(Base):
    ____tablename__ = 'sat_time_episode_details'
    # __table_args__ = {'schema': 'insert random schema name here'}
    id = Column(Integer, primary_key=True)
...
class SatEventEpisodeDetails(Base):
    ____tablename__ = 'sat_event_episode_details'
    # __table_args__ = {'schema': 'insert random schema name here'}
    id = Column(Integer, primary_key=True)
...
class SatPersonMedicalSpecialty(Base):
    ____tablename__ = 'sat_person_medical_specialty'
    # __table_args__ = {'schema': 'insert random schema name here'}
    id = Column(Integer, primary_key=True)
...
class sat_event_medication_details(Base):
